...
class Auth {
  ...
  getSignatureData(signerAddress: string, timestamp: number): string {
    return `I allow this site to access my data on Rward using the account ${signerAddress}. Timestamp:${timestamp}`;
  }
  ...
  getSignatureDataV2(
    ...
    const message = new SiweMessage({
      ...
      uri: uri,
      version: '1',
      statement: 'I allow this site to access my data on Rward.',
      nonce: generateNonce(),
